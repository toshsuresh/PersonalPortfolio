            ...
            <div className="md:w-2/3">
              <div className="prose prose-invert max-w-none text-center md:text-left">
                ...
                <p className="text-lg leading-relaxed md:hidden">
                  Hi, I'm Santosh! I'm pursuing dual degrees in Computer Science Honors and Economics with an Advanced
                  Cybersecurity Minor at UMD. I'm passionate about developing innovative software solutions and
                ...
                <div className="hidden md:block">
                  ...
                  <p className="mb-4">
                    Hi, I'm Santosh! I'm pursuing dual degrees in Computer Science Honors and Economics with an Advanced
                    Cybersecurity Minor at the University of Maryland. I'm passionate about developing innovative
                    software solutions and leveraging data science to solve complex problems.
                  </p>
                  <p className="mb-4">
                  ...
                  <div className="md:w-1/2 p-6 bg-gray-900/50 rounded-xl backdrop-blur-sm border border-gray-800">
                    <div className="flex flex-col md:flex-row items-center gap-4">
                      <div className="w-16 h-16 md:w-12 md:h-12 rounded-full bg-gray-800 flex items-center justify-center overflow-hidden mb-4 md:mb-0 mx-auto md:mx-0">
                        <Image
                          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/jpmcicon-oPfvNYm4kKuBdtpmUlf6cgptXxFL0l.png"
                      ...
                      <div className="text-center md:text-left">
                        ...
                        <div className="flex items-center justify-center md:justify-start gap-2 text-gray-400 mt-1">
                          ...
                          <span className="text-sm">Incoming Summer 2025</span>
                        </div>
