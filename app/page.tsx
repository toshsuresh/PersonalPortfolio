        ...
        vantaScript.onload = () => {
          ...
          if (window.VANTA && window.THREE && vantaRef.current) {
            vantaEffect = window.VANTA.DOTS({
              ...
              color2: 0xec4899, // Pink color to match theme
        ...
        <div className="container px-4 mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <ProjectCard
                title="ReachSearch"
                description="Published iOS app with 1k+ downloads using Swift frontend with Firebase authentication and resume integration to help students discover and reach out to research-matching professors faster."
                tags={["Swift", "Xcode", "Firebase", "MongoDB", "AWS", "Node.js"]}
                image="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-06-22%20at%205.28.09%E2%80%AFPM-HFxOTwCQesE9NFlsae4EZic5U6tCbV.png"
              />
              <ProjectCard
                title="FireSync"
                ...
                image="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-06-22%20at%205.19.18%E2%80%AFPM-hSwXDb2zI8ZMlS7IOPwvaH1b1gHnjE.png"
              />
              <ProjectCard
                title="NPOConnect"
                ...
                image="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-06-22%20at%205.34.27%E2%80%AFPM-sTJGzo7j3PxdZ7cu9gML7xqJAkOkz2.png"
              />
              <ProjectCard
                title="SkyCast"
                ...
                image="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-06-22%20at%205.44.11%E2%80%AFPM-OQdfrvDWTO0MJsW4mwHiMlrhlLYftu.png"
              />
              <ProjectCard
                title="SaveAPlate"
                ...
                image="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-06-22%20at%205.19.51%E2%80%AFPM-R0GWRiVkHX6xakInnM8DqD54xJJvYn.png"
              />
            </div>
          </motion.div>
        </div>
...
function ProjectCard({ title, description, tags, image }) {
  return (
    <div className="p-6 rounded-lg bg-gray-900 border border-gray-800 hover:border-purple-500 transition-all duration-300">
      {image && (
        <div className="mb-4 relative h-48 w-full rounded-lg overflow-hidden bg-gray-800">
          <Image
            src={image || "/placeholder.svg"}
            alt={title}
            fill
            className={`hover:scale-105 transition-transform duration-300 ${
              title === "FireSync" || title === "NPOConnect" || title === "SkyCast" ? "object-contain" : "object-cover"
            }`}
          />
        </div>
      )}
